...
export default function FAQ() {
  ...
  const faqData: FAQItem[] = [
    ...
    },
    {
      id: 3,
      question: "Seating",
      answer: "The ceremony will be held on a tiered deck overlooking the Fraser Canyon. The lower deck seating will be reserved for immediate family and the wedding party. There is an upper deck with additional seating for our guests and we will ask that some guests who are willing and able stand for the ceremony."
    },
    {
      id: 4,
      question: "The Bar",
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <h1 className={styles.title}>
            <span className={styles.regularFont}>The Details</span>
          </h1>
        </div>
